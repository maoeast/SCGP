# Requirements Archive: v1.1 Emotional Authoring & Scene Gallery
...
- v1.1 deliberately stayed within the current static-route architecture.
- v1.1 did not expand into database field migration, cloud sync, or resource pack exchange.
