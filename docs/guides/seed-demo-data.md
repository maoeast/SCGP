...
| 数据 | 规模 |
|---|---|
| 学生 | 22 人（男 15 / 女 7，常见姓名，诊断集中学习障碍 7 / 言语障碍 6 / 多重障碍 5，补充自闭症谱系 2 / 智力障碍 2） |
| 班级 | 7 个：大班、一年级~三年级、初一~初三（2026-2027 学年） |
| 教师 | 5 人（`teacher01`~`teacher05`，密码统一 `admin123`） |
| 评估 | 每生 2-4 个量表（sm / weefim / csirs / cnbsr2016 / fine_motor / crt / srs2 / conners-psq / sdq / cbcl / brief），约一半量表做**前测+后测**（2026-03 前测 → 训练 → 2026-07 后测，分数提升体现训练进步，趋势页可见） |
| 计划 | 每生 1 个进行中计划（挂 2-4 个活跃资源）+ 约 1/3 学生 1 个历史完成计划 |
| 训练记录 | 2026-04 ~ 2026-07：感官游戏 8-14 条 + 器材 3-6 条 + 情绪场景 3-5 条 + 情绪游戏 1-3 条；同步写入 `training_session` 统一主表 |
