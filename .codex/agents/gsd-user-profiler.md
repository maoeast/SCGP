...
<reference>
@/home/DONG/Mycode/SCGP/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/DONG/Mycode/SCGP/.codex/get-shit-done/references/user-profiling.md` to load:
