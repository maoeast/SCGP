...
- **Global scope**: `/home/DONG/Mycode/SCGP/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/DONG/Mycode/SCGP/.codex/notes/`)
...
2. Glob `/home/DONG/Mycode/SCGP/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/DONG/Mycode/SCGP/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/DONG/Mycode/SCGP/.codex/notes/` — works in any directory
