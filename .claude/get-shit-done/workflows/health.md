...
```bash
node "E:/VSC/H5/SIC-ADS/.claude/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "E:/VSC/H5/SIC-ADS/.claude/get-shit-done/bin/gsd-tools.cjs" validate health
```
