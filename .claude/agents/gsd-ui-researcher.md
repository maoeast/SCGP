...
Use template from `E:/VSC/H5/SIC-ADS/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/VSC/H5/SIC-ADS/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/VSC/H5/SIC-ADS/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
