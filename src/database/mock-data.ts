...
const mockData: MockTableData = {
  ...
  system_config: [
    ...
    { id: 4, key: 'theme_primary_color', value: '#2f6fd6', description: '登录页主色' },
    { id: 5, key: 'brand_panel_title', value: '评估、训练与报告协同工作台', description: '登录页品牌主标题' },
    { id: 6, key: 'brand_panel_subtitle', value: '为学校和康复团队提供清晰、稳定、可持续维护的日常入口。', description: '登录页品牌副标题' },
    { id: 7, key: 'brand_panel_description', value: '统一进入学生管理、能力评估、训练计划、训练记录与报告生成，让一线工作更聚焦。', description: '登录页品牌说明' },
