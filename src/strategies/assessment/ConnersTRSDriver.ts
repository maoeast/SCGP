...
export class ConnersTRSDriver extends BaseDriver {
  ...
  getWelcomeContent() {
    return {
      ...
      intro: '从高要求、多干扰的集体环境中，评估孩子听课状态、同伴交往及规则遵守情况，捕捉在家庭中不易暴露的问题。',
      sections: [
        {
          icon: '👨‍🏫',
          title: '给专业人员的实操心法',
        ...
        },
        {
          ...
          items: [
            ...
            '做客观的“班级录像机”：请摘下对某个捣乱事件的“情绪滤镜”，以班级里同龄孩子的平均水平为参照物，而不是以“完美模范生”为标准。',
          ],
        },
      ],
      reminder: {
        ...
        title: '特别提醒',
        content:
          '本问卷结果仅供学校优化课堂生态和提供融合教育支持参考，不能直接作为多动症等临床诊断依据。如课堂行为异常显著，建议家长带孩子前往正规医院发育行为科或精神心理科进一步评估。',
      },
    }
  }
