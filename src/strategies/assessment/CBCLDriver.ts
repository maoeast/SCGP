...
export class CBCLDriver extends BaseDriver {
  ...
  getWelcomeContent() {
    return {
      ...
      intro: '孩子的心理健康全息雷达，全面扫描焦虑、抑郁、退缩、躯体化、违纪及攻击等深层心理与行为问题。',
      sections: [
        {
          icon: '👨‍🏫',
          title: '给专业人员的实操心法',
        ...
        },
        {
          ...
          items: [
            ...
            '时间刻度是六个月：如果孩子最近刚换学校、经历重大事件，请在填写时备注。我们要评估的是长期心理特质，而不是短暂的适应性危机。',
          ],
        },
      ],
      reminder: {
        ...
        title: '特别提醒',
        content:
          '本系统的心理健康扫描结果仅供学校提供心理辅导和危机干预参考，不能作为抑郁症、焦虑症等精神疾病的诊断依据。如发现躯体化、自伤等高危信号，请务必立即前往正规医院精神心理科就诊。',
      },
    }
  }
