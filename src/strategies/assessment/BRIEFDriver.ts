...
export class BRIEFDriver extends BaseDriver {
  ...
  getWelcomeContent() {
    return {
      ...
      intro:
        '评估孩子在抑制、转换、工作记忆、计划组织等执行功能上的日常表现。由最了解孩子的家长或老师填写。',
      sections: [
        {
          icon: '📝',
          title: '填写说明',
          items: [
            '根据孩子最近一段时间（近 6 个月）的日常真实表现作答，不要依据某一天的状态。',
            '每题三档：从不 / 有时 / 经常，选择最贴近的频率。题目描述的是"困难行为"，越频繁得分越高。',
            '若某题在不同情境下表现不同，请按总体最常见的频率判断。',
          ],
        },
        {
          icon: '⚠️',
          title: '草稿与用途说明',
          items: [
            '本量表为自编题目 + 占位常模的草稿版，仅用于筛查与发展监测，不能作为临床诊断依据。',
            '如结果提示显著风险，请前往正规机构由专业人员做进一步评估。',
          ],
        },
      ],
      reminder: {
        ...
        title: '特别提醒',
        content:
          '本结果仅供教育支持参考，不能作为医学诊断依据。如发现显著异常，请前往正规医院发育行为儿科或精神心理科就诊。',
      },
    }
  }
