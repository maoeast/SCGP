...
export class BRIEFDriver extends BaseDriver {
  ...
  getWelcomeContent() {
    return {
      ...
      intro: '看孩子大脑的"总指挥部"是不是在线。从控制冲动、转换任务、记住事情，到提前计划、检查错误，测量孩子在真实生活中的执行功能表现。',
      sections: [
        {
          icon: '👨‍🏫',
          title: '给专业人员的实操心法',
      ...
      reminder: {
        ...
        title: '特别提醒',
        content:
          '本量表为自编简化版，仅供学校设计执行功能支持策略参考，不能作为ADHD或其他神经发育障碍的诊断依据。如执行功能困难显著影响学习和生活，建议前往正规医院儿童精神心理科或发育行为科进行专业评估。',
      },
    }
  }
