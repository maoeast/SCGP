...
export class Gmfm88Driver extends BaseDriver {
  ...
  getWelcomeContent() {
    return {
      title: 'GMFM-88 粗大运动功能评定量表',
      intro: '本评估将按 GMFM-88 的五个能区完成 88 个项目评分，系统自动计算五区百分比和总分。',
      sections: [
        {
          icon: '📋',
          title: '评分方式',
          content: '每题使用 0 / 1 / 2 / 3 / NT 五档评分，NT 会保留标记并按 0 分计入。',
        },
        {
          icon: '📊',
          title: '总分逻辑',
          content: 'GMFM-88 总分不是原始分直除，而是五个能区百分比的平均值。',
        },
        {
          icon: '🎯',
          title: '干预重点',
          content: '系统会优先从低分能区中提取接近达成或明显受限的项目，生成近期 IEP 关注点。',
        },
      ],
      footer: '请按儿童真实表现评分；如项目未测试，可选择 NT。',
    }
  }
