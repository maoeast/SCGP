...
export class Cnbsr2016Driver extends BaseDriver {
  ...
  getWelcomeContent() {
    return {
      ...
      intro: '用于追踪0-6岁儿童在五大能力领域（大运动、精细、适应、语言、社交）的发育进展，建议每6-12个月评估一次。儿心量表Ⅱ采用basal/ceiling规则，通过测定"发育年龄"（心理年龄）和计算"发育商"（DQ），精准定位孩子在每个能区的发育水平，绘制五大能力的"发育雷达图"。',
      sections: [
        {
          icon: '👨‍🏫',
          title: '给专业人员的实操心法',
          items: [
            '儿心量表Ⅱ是发育追踪工具，建议每6-12个月评估一次：本量表通过计算五大能区的发育商（DQ = 心理年龄/实际年龄×100），适合定期监测发育迟缓、智力障碍、早产儿等儿童的发育进展。每6-12个月评估一次，观察各能区DQ变化趋势和"发育雷达图"形状变化。',
            ...
            '用DQ变化速度评估干预效果：如果一个发育迟缓儿童，第一次评估大运动DQ=65，经过6个月早期干预后复测DQ=72，再6个月后DQ=78，持续增长说明干预有效。即使DQ仍<85（边界），但上升趋势本身就是进步。',
            '关注"能区剪刀差"：有的孩子语言DQ=50但适应DQ=85，这种巨大差异提示特定领域障碍（如语言发育障碍）而非整体智力低下，干预重点应放在薄弱能区。',
          ],
        },
        {
          icon: '❤️',
          title: '给家长的填表大实话',
          items: [
            '儿心量表Ⅱ是看"发育进步"的量表，建议每半年到一年做一次：如果您的孩子有发育迟缓、早产、或智力发育担忧，本量表可以帮您看到他在五大能力上的具体进步。比如半年前大运动发育年龄18个月（实际年龄24个月，DQ=75），现在发育年龄22个月（实际年龄30个月，DQ=73），虽然DQ略降但发育年龄增长4个月说明在进步。',
            ...
            '看长期趋势而非单次DQ：一次评估总DQ=70（轻度迟缓）不用太焦虑，重要的是半年后复测是涨到75还是保持70甚至降到65。持续追踪才能看到孩子的真实发育轨迹和干预效果。',
          ],
        },
      ],
      reminder: {
        ...
        title: '特别提醒',
        content:
          '儿心量表Ⅱ是发育追踪工具，建议每6-12个月评估一次以监测0-6岁儿童五大能区发育进展。本量表评估结果仅供学校开展特殊教育教学支持参考，不能作为智力障碍等医学诊断依据。如发现显著发育迟缓（DQ<70且持续下降），请前往正规儿童医院发育行为科或儿童保健科进行全面评估。',
      },
    }
  }
