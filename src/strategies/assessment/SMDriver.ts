...
export class SMDriver extends BaseDriver {
  ...
  getWelcomeContent() {
    return {
      ...
      intro: '用于追踪儿童社会适应能力和生活技能的发展进程，建议每6-12个月评估一次。S-M量表通过测量孩子在真实社会环境中的"生存技能"，从自理能力到社会参与，全面监测儿童的社会成熟度发展轨迹。',
      sections: [
        {
          icon: '👨‍🏫',
          title: '给专业人员的实操心法',
          items: [
            'S-M是发育追踪工具，建议每6-12个月评估一次：S-M量表计算社会年龄（SA）和社会商数（SQ），适合定期监测发育迟缓、智力障碍、孤独症等儿童的社会适应能力发展。每6-12个月评估一次，观察SA增长速度和SQ变化趋势。',
            '打破"高智商低能儿"的幻觉：很多自闭症或ADHD孩子，智商测出来很高，但S-M量表只在边缘水平。你要重点关注这种"能力剪刀差"——智商120但SQ只有70，说明需要强化生活技能训练。',
            '核实"包办"水分：当家长给"独立洗澡""自己整理书包"打高分时，要继续追问他是不是在家长递毛巾、检查重装的情况下完成。很多"独立"其实是"在家长全程指挥下完成"。',
            '关注"退行"信号：如果复测时发现SQ下降（如从85降到78），且一个已经上小学的孩子突然连自己穿鞋都不愿意做了，往往不是能力丧失，而是学校霸凌、极度焦虑或抑郁等更深层问题的信号。',
            '用SA增长速度评估干预效果：正常儿童每过6个月，SA应增长6个月。如果一个发育迟缓儿童，第一次评估SA=24个月（实际年龄36个月，SQ=67），经过6个月生活技能训练后复测SA=28个月（实际年龄42个月，SQ=67），虽然SQ不变，但SA增长4个月说明干预有效。',
          ],
        },
        {
          icon: '❤️',
          title: '给家长的填表大实话',
          items: [
            'S-M是看"生活能力进步"的量表，建议每半年到一年做一次：如果您的孩子有发育迟缓或智力障碍，S-M可以帮您看到他的生活技能是否在进步。比如半年前还不会自己穿衣，现在能穿上衣了，这些具体进步S-M都能反映出来。',
            '抛开"智商滤镜"看生存：您的孩子可能英语单词倒背如流，但在填这个表时，请只看他"能不能自己过马路""会不会去超市买瓶酱油"这类真实生活能力。',
            '这是在给您的"放手"打分：如果您发现这上面一大半项目，孩子都不会做，请先别急着骂孩子笨，先问问自己有没有真的给过他练习和尝试的机会。每半年到一年复测一次，也是在检查您是否真的在教孩子生活技能。',
            '用"现在的他"来答题：请不要填"他以前会，只是现在懒得做"，也不要填"只要我好好教，他肯定能学会"。只看他今天、此时此刻，在没有催促和帮助下到底能不能做完。',
            '看长期趋势而非单次分数：一次S-M评估得出SQ=70不用太焦虑，重要的是半年后复测是涨到75还是降到65。持续追踪才能看到孩子的真实发展轨迹。',
          ],
        },
      ],
      reminder: {
        ...
        title: '特别提醒',
        content:
          'S-M量表是社会适应能力发展追踪工具，建议每6-12个月评估一次以监测儿童生活技能发展进程。如果社会生活能力极度落后于年龄（SQ<70且持续下降），建议前往正规医院发育行为科进行全面评估。',
      },
    }
  }
