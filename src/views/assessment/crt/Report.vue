  ...
  <div class="crt-report">
    <el-card class="report-header">
      <template #header>
        <div class="header-content">
          <div class="header-left">
            ...
            <h2>瑞文 CRT 图形推理评估报告<el-tag size="small" type="warning" class="draft-tag">自编 DRAFT</el-tag></h2>
          </div>
        </div>
      </template>
      ...
      <div class="overview" v-if="assessData">
        ...
        <div class="score-item">
          ...
          <div class="score-value">{{ assessData.total_raw_score ?? 0 }} / {{ assessData.total_questions ?? 0 }}</div>
          <div class="score-range">共 {{ assessData.total_questions ?? 0 }} 题</div>
        </div>
      </div>
    </el-card>
    ...
    <el-card class="disclaimer">
      <div class="disclaimer-content">
        ...
        <p>
          <strong>重要提示：</strong>本测验为「自编占位题 + 占位常模」的草稿版，矩阵图由代码按公开推理规律生成，
          <strong>非瑞文标准图（Pearson 版权）</strong>，无标准化效度。结果仅供教育支持与发展监测参考，
