...
export const ASSESSMENT_SCALE_CATALOG: AssessmentScaleCatalogItem[] = [
  ...
  },
  {
    ...
    reportTone: 'blue',
    reportTagType: 'primary',
    reportSelectLabel: 'BRIEF 执行功能报告',
  ...
  },
  {
    ...
    ageRange: '5.5 - 16.5岁',
    questionCount: '16道正式题 + 2道练习',
    dimensions: '评估维度：基础匹配、精细辨别、双属性交叉、高相似逼近；记录正确率、反应时与错误类型',
    timeEstimate: '约5-8分钟',
    studentSelectorTitle: '选择评估学生 - 视知觉图形匹配筛查（DRAFT）',
    studentSelectorTag: {
      type: 'primary',
      label: '视知觉图形匹配筛查',
      description: '评估儿童视觉图形匹配表现（儿童本人作答，绩效题，描述性结果）',
    },
    entryTabs: ['cognitive'],
    accessEntitlementsAnyOf: ['cognitive'],
    accessModulesAnyOf: ['cognitive'],
    ...
    reportMetaTitle: '视知觉图形匹配筛查（DRAFT）评估报告',
    reportTone: 'amber',
    reportTagType: 'primary',
    reportSelectLabel: '视知觉匹配筛查报告',
  ...
  },
  {
    ...
    ageRange: '3岁以上',
    questionCount: '57道',
    dimensions: '评估维度：感觉、交往、躯体运动、语言、生活自理',
    timeEstimate: '约15-20分钟',
    studentSelectorTitle: '选择评估学生 - ABC孤独症行为评定量表',
    studentSelectorTag: {
      type: 'warning',
      label: 'ABC 孤独症行为',
      description: '评估儿童孤独症相关行为表现',
    },
    ...
    urlSlug: 'abc',
    reportRouteName: 'ABCReport',
    reportPathParamStyle: 'params',
    reportComponentFolder: 'abc',
    reportMetaTitle: 'ABC孤独症行为评定量表报告',
    reportTone: 'coral',
    reportTagType: 'warning',
    reportSelectLabel: 'ABC 孤独症行为报告',
    reportCardLabel: 'ABC',
    recordsLabel: 'ABC孤独症行为量表',
    isDraft: false,
    trendSupported: true,
    trendRouteName: 'ABCTrend',
  },
  {
    code: 'atec',
    title: '孤独症治疗评估量表',
    ...
    ageRange: '2岁以上',
    questionCount: '77道',
    dimensions: '评估维度：言语/语言/交流（14题）、社交能力（20题）、感觉/认知意识（18题）、健康/生理/行为（25题）',
    timeEstimate: '约15-20分钟',
    studentSelectorTitle: '选择评估学生 - ATEC孤独症治疗评估量表',
    studentSelectorTag: {
      type: 'success',
      label: 'ATEC 治疗评估',
      description: '评估孤独症治疗效果与症状变化',
    },
    entryTabs: ['social-communication', 'emotional-regulation', 'sensory-integration'],
    accessEntitlementsAnyOf: ['social_communication', 'emotional', 'sensory_integration'],
    accessModulesAnyOf: ['social', 'emotional', 'sensory'],
    urlSlug: 'atec',
    reportRouteName: 'ATECReport',
    reportPathParamStyle: 'params',
    reportComponentFolder: 'atec',
    reportMetaTitle: 'ATEC孤独症治疗评估量表报告',
    reportTone: 'teal',
    reportTagType: 'success',
    reportSelectLabel: 'ATEC 治疗评估报告',
    reportCardLabel: 'ATEC',
    recordsLabel: 'ATEC孤独症治疗量表',
    isDraft: false,
    trendSupported: true,
